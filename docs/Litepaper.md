# COSMEX - Provably Solvent Semi-Centralised Off-chain (L2) Order Book Exchange for Cardano

COSMEX is a RealFI project that combines speed of centralised order book exchanges and ownership guaranties of decentralised protocols.
COSMEX uses a novel approach that uses multiple star-shaped two-party state channels.

No one can lock/steal your funds. You _always_ can withdraw your money from the exchange.
Exchange can withdraw money only according to your trading orders.

Hydra-like state channels, specialized star-shaped Hydra.

First ever centralised exchange where clients actually own their tokens. First ever provably solvent exchange.

Experience lightning-fast trades with COSMEX, the RealFI project that guarantees ownership of your funds through its unique use of star-shaped two-party state channels. Enjoy complete control over your funds with COSMEX's withdrawal feature, ensuring that no one can ever lock or steal your assets.
...
- [What is the difference between Cosmex and Hydra?](#what-is-the-difference-between-cosmex-and-hydra)
- [What is the difference between Cosmex and Uniswap?](#what-is-the-difference-between-cosmex-and-uniswap)
- [What is the difference between Cosmex and a centralized exchange?](#what-is-the-difference-between-cosmex-and-a-centralized-exchange)

### What is the difference between Cosmex and Hydra?
...
### What is the difference between Cosmex and Uniswap?
...
### What is the difference between Cosmex and a centralized exchange?
...
data OnChainState = OnChainState
  { clientPkh :: PubKeyHash
  , clientPubKey :: BuiltinByteString
